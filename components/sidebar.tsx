  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="text-secondary-foreground dark:text-primary-foreground text-sm group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0"
      >
        {link.label}
      </motion.span>
    </a>
